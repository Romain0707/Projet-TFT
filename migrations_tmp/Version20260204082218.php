 ...
 */
final class Version20260204082218 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personnage ADD portee INT NOT NULL');
        $this->addSql('ALTER TABLE personnage ADD CONSTRAINT FK_6AEA486DD60322AC FOREIGN KEY (role_id) REFERENCES role (id)');
        $this->addSql('ALTER TABLE personnage RENAME INDEX idx_937ab034d60322ac TO IDX_6AEA486DD60322AC');
        ...
        $this->addSql('ALTER TABLE team_personnage RENAME INDEX idx_247faed3296cd8ae TO IDX_54333AA8296CD8AE');
        $this->addSql('ALTER TABLE team_personnage RENAME INDEX idx_247faed31136be75 TO IDX_54333AA85E315342');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personnage DROP portee');
        $this->addSql('ALTER TABLE personnage RENAME INDEX idx_6aea486dd60322ac TO IDX_937AB034D60322AC');
        ...
        $this->addSql('ALTER TABLE team_personnage RENAME INDEX idx_54333aa8296cd8ae TO IDX_247FAED3296CD8AE');
        $this->addSql('ALTER TABLE team_personnage RENAME INDEX idx_54333aa85e315342 TO IDX_247FAED31136BE75');
    }
}
